<?php
namespace tests\units\DidUngar\Jenkins;
...
class TestReport extends atoum\test
{
    ...
    {
        $jenkins    = new \mock\DidUngar\Jenkins('url');

        $reportJson = json_decode(file_get_contents(__DIR__ . '/report_passed.json'));
        $report     = new \DidUngar\Jenkins\TestReport($jenkins, $reportJson, $jobName = 'units', $buildNumber = '32');
